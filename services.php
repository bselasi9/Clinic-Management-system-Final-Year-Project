...
.menu li {
	...
	margin-left:2px;
     ...
     <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px;margin-top: 1% !important; margin-left: 15%;"><h1 align="center"><strong>CU<br> CLINIC</strong></h1>
...
<div class="container">
        <h2 style="color:maroon">Our Services</h2>
        <section class="services">
            <div class="card">
                <div class="content">
                    <div class="icon"><img src="gallery/anaesthesia.jpeg" alt="lights" style="width:100%"></div>
                    <div class="text" style="color:black"><a href="" style="color:black">Anaesthesia</a></div>
                </div>
            </div>
            <div class="card">
                <div class="content">
                    <div class="icon"><img src="gallery/ChildHealth.jpg" alt="lights" style="width:100%"></div>
                    <div class="text" style="color:black"><a href="" style="color:black">Child health services</a></div>
                </div>
            </div>
            <div class="card">
                <div class="content">
                    <div class="icon"><img src="gallery/pharmacy.jpeg" alt="lights" style="width:100%"></div>
                    <div class="text" style="color:black"><a href="" style="color:black">Pharmaceutical services</a></div>
                </div>
            </div>
            <div class="card">
                <div class="content">
                    <div class="icon"><img src="gallery/ambulance.jpeg" alt="lights" style="width:100%"></div>
                    <div class="text" style="color:black"><a href="" style="color:black">Ambulance Services</a></div>
                </div>
            </div>
            <div class="card">
                <div class="content">
                    <div class="icon"><img src="gallery/theatre.jpeg" alt="lights" style="width:100%"></div>
                    <div class="text" style="color:black"><a href="" style="color:black">Theatre</a></div>
                </div>
            </div>
            <div class="card">
                <div class="content">
                    <div class="icon"><img src="gallery/outpatient.jpg" alt="lights" style="width:100%"></div>
                    <div class="text" style="color:black"><a href="" style="color:black">Outpatient</a></div>
                </div>
            </div>
            <div class="card">
                <div class="content">
                    <div class="icon"><img src="gallery/generalpractice.jpg" alt="lights" style="width:100%"></div>
                    <div class="text" style="color:black"><a href="" style="color:black">General Practice</a></div>
                </div>
            </div> 
            <div class="card">
                <div class="content">
                    <div class="icon"><img src="gallery/family.jpg" alt="lights" style="width:100%"></div>
                    <div class="text" style="color:black"><a href="" style="color:black">Family medicine</a></div>
                </div>
            </div>
            <div class="card">
                <div class="content">
                    <div class="icon"><img src="gallery/lab.jpeg" alt="lights" style="width:100%"></a></div>
                    <div class="text"><a href="" style="color:black">Laboratory services</div>
                </div>
            </div> 
        </section>
    </div>
