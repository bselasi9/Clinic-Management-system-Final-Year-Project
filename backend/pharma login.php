<?php
    ...
    if(isset($_POST['doc_login']))
    {
        ...
        if($rs)
            {//if its sucessfull
                header("location:his_doc_dashboard3.php");
            }
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="Management portal.php">
                                        <span style="color:maroon">CU CLINIC| PHARMACIST LOGIN<span>
                                    </a>
                                    <p class="text-muted mb-4 mt-3">Enter your email address and password to access Pharmacist panel.</p>
                                </div>

                                <form method='post' >

                                    <div class="form-group mb-3">
                                        <label for="emailaddress">Pharmacist Number</label>
                                        <input class="form-control" name="doc_number" type="text" id="emailaddress" required="" placeholder="Enter your Pharmacist number">
                                    </div>
