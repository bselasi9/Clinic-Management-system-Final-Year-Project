                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="his_admin_logout.php">
                                        <span style="color:maroon">CU CLINIC</span>
                                    </a>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Back to <a href="pharma login.php" class="text-white ml-1"><b>Log In</b></a> OR <a href="../../Management portal.php" class="text-white ml-1"><b>Management Portal</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
