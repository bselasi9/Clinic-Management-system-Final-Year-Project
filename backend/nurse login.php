<?php
    ...
    if(isset($_POST['doc_login']))
    {
        ...
        if($rs)
            {//if its sucessfull
                header("location:his_doc_dashboard1.php");
            }
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="Management portal.php">
                                        <span style="color:maroon">CU CLINIC| NURSE LOGIN<span>
                                    </a>
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="doc_number" type="text" id="emailaddress" required="" placeholder="Enter your Nurse number">
                                    </div>
