...
?>
    <div class="navbar-custom">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <a href="his_doc_update-account2.php" class="dropdown-item notify-item">
                    ...
                    <!-- item-->
                    <a href="his_doc_logout_partial1.php" class="dropdown-item notify-item">
        ...
        <!-- LOGO -->
        <div class="logo-box">
            <a href="his_admin_dashboard1.php" class="logo text-center">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- item-->
                    <a href="his_doc_register_patient1.php" class="dropdown-item">
